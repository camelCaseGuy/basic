...
280 NEXT I
290 IF W$="" THEN V$=Q$
300 FOR I=1 TO V : REM VERB
310 IF V$=V$(I) THEN VB=I
320 NEXT I
330 FOR I=1 TO W : REM OBJ
...
810 IF (RM=26 AND F(0)=0) AND (D=I OR D=4) THEN M$="YOU NEED A LIGHT":RETURN
...
1175 REM *** SAY ***
1180 M$="OK '"+W$+"'"
1190 IF C(3)=1 AND OB=34 THEN M$="*MAGIC OCCUR*":IF R<>45 THEN RM=RND(63)
...
1320 IF OB=14 AND C(14)<>1 AND RM=7 AND F(14)=1 THEN N$ "GOING DOWN":F(14)=0
1330 RETURN
1335 REM *** LIGHT ***
...
1360 IF OB=17 AND C(17)=I AND C(9)=1 AND C(8)=1 THEN M$="IT CASTS A FLICKERING LIGHT":F(0)=1
1370 RETURN
1375 REM *** UNLIGHT ***
...
1540 NEXT I
1550 IF S=17 AND C(15)<>1 AND RM<>157 THEN PRINT "YOU HAVE EVERYTHING":PRINT "RETURN TO THE GATE FOR FINAL SCORE"
...
1590 RETURN
1595 REM *** INITIALIZATION ***
1600 DIM R$(63),D$(63),O$(W),V$(V)
1610 DIM C(W),L(G),F(W)
1620 DATA 46,38,35,50,13,18,28,42,10,25,26,4,2,7,47,60,43,32
1630 FOR I=1 TO G : REM OBJECTS
1640 READ L(I) : REM OBJECT LOCATION
1650 NEXT I
1660 DATA HELP,INVENTORY,GO,N,S,W,E,U,D,GET,TAKE,OPEN,EXAMINE,READ,SAY
1665 DATA DIG,SWING,CLIMB,LIGHT,UNLIGHT,SPRAY,USE,UNLOCK,LEAVE,SCORE
1680 FOR I=1 TO V : REM VERBS
1690 READ V$(I)
1700 NEXT I
...
1980 FOR I=0 TO 63 : REM DESCRIPTIONS
1990 READ D$(I)
2000 NEXT I
...
2060 FOR I=1 TO W : REM WORDS, OBJECTS
2070 READ O$(I)
2080 NEXT I
2090 F(18)=1:F(17)=1:F(2)=1:F(26)=1:F(28)=1:F(23)=1:LL=60:RM=57:W$="OK" : REM FLAGS
2100 RETURN
2110 REM *** END OF PROGRAM ***